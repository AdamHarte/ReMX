package
{
	...
	public final class Demo extends Game
	{
		...
		public function Demo()
		{
			...
			// SET THE BACKGROUND COLOR FOR THE SCREENS (OPTIONAL).
			config.gameBackground = 0xFFFFFF; // The default is 0x000000 (black).

			// ENABLE THE PROFILER (OPTIONAL).
			// The profiler will appear as a 40px high bar at the top of each screen.
			config.profile = true; // The default is FALSE.
